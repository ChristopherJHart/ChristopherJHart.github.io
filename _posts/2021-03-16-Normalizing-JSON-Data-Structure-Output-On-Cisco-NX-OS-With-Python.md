...
An example of the Python script you might build for this task can be found in the [Examples folder of the Normalize NX-OS JSON Data Structures GitHub repository](https://github.com/ChristopherJHart/normalize-nxos-json-data-structures/blob/main/examples/eigrp_neighbors.py). The corresponding unit tests for this script can be found in the [Tests folder of the same repository](https://github.com/ChristopherJHart/normalize-nxos-json-data-structures/blob/main/tests/test_examples/test_eigrp_neighbors.py).
